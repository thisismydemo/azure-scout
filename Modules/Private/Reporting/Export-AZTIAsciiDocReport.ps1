...
.Link
https://github.com/thisismydemo/azure-inventory/Modules/Private/Reporting/Export-AZTIAsciiDocReport.ps1
...
function Export-AZTIAsciiDocReport {
    ...
    $lines.Add('AzureTenantInventory')
    $lines.Add(":toc: left")
    ...
    $lines.Add('[NOTE]')
    $lines.Add('====')
    $lines.Add("This report was auto-generated by *AzureTenantInventory* on `$genDate`.")
    $lines.Add('')
    ...
    $lines.Add("[NOTE]")
    $lines.Add('====')
    $lines.Add("Generated by link:https://github.com/thisismydemo/azure-inventory[AzureTenantInventory] at $genDate")
    $lines.Add('====')
