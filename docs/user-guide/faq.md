...
This page answers common questions about Azure Tenant Inventory.

## General Questions

### What is Azure Tenant Inventory?

Azure Tenant Inventory (AZTI) is a PowerShell module that generates detailed Excel reports about your Azure resources. It helps you document and inventory your Azure environment with minimal effort.

### Is AZTI an official Microsoft product?

AZTI is developed by Microsoft engineers and published on the official Microsoft GitHub account, but it's an open-source tool provided as-is without official Microsoft support.

### Does AZTI make any changes to my Azure environment?

No, AZTI is a read-only tool that only collects information about your Azure resources. It doesn't make any changes to your environment.

### What operating systems does AZTI work on?

AZTI works on any operating system that supports PowerShell 7, including:
- Windows
- macOS
- Linux
- Azure Cloud Shell
...
Yes, AZTI is open source and free to use under the MIT license.

## Technical Questions

### How does AZTI collect information?

AZTI primarily uses Azure Resource Graph and other Azure PowerShell modules to collect information about your resources efficiently.

### Does AZTI require the Azure portal to work?

No, AZTI is a PowerShell module that doesn't require the Azure portal. It works directly with the Azure APIs.
...
### Can I run AZTI on a schedule?

Yes, you can use Azure Automation to run AZTI on a schedule. See the [Automation Guide](../advanced/automation.md) for details.

### Does AZTI support Azure Stack?

AZTI is designed for Azure public cloud. It may work partially with Azure Stack, but full compatibility is not guaranteed.

### What permissions do I need to run AZTI?
...
### Does AZTI collect sensitive data?

AZTI collects resource configurations but doesn't collect sensitive data like passwords, connection strings, or keys. However, it may collect resource names and other metadata that your organization considers sensitive.

### Can I export the report to other formats?

AZTI generates an Excel file, which you can then export to other formats using Excel or other tools.
...
### Can I run AZTI without an internet connection?

No, AZTI needs to connect to Azure APIs to collect resource information.

## Troubleshooting Questions

### AZTI fails with an authentication error. What should I do?

Make sure you're properly authenticated to Azure by running `Connect-AzAccount` before running AZTI, or by using the correct authentication parameters.
...
- The resource type isn't supported by AZTI

### Why does AZTI run slowly in my environment?

AZTI's performance depends on:
