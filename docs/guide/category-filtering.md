...
4. Update [Category Structure](../reference/category-structure.md) with the new mapping
5. Create one or more `.ps1` module files using the module template in `manifests/collectors/`

## See Also

- [Category Structure reference](../reference/category-structure.md)
- [Full Coverage Table](../reference/coverage-table.md)
