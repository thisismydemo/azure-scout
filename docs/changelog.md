...
[View CHANGELOG.md on GitHub](https://github.com/thisismydemo/azure-scout/blob/main/CHANGELOG.md){ .md-button .md-button--primary }
...
| **v1.0.0** | Full rename to AzureScout (AZSC prefix), 170+ ARM modules, 15 Entra ID modules, Excel + JSON + Markdown + AsciiDoc output, draw.io diagrams, permission pre-flight, category filtering |
