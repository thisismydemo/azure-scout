# azure-scout — Claude Code Context
...
- `azure-scout-engineer` (model: sonnet) — Expert in `azure-scout`: deep knowledge of this repo's structure, conventions, and development workflow.
